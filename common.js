...
const I18N = {
  en: {
    ...
    compareRaisedTitle: 'Declared raises',
    compareRaisedNote: 'Amounts declared in Form C-U milestone updates over the period.',
    raisedTimeTitle: 'Cumulative declared raises over time',
    raisedTimeNote: 'Running total of the amounts declared raised (Form C-U milestone updates) since the start of data collection — full history, unaffected by the period filter. Drag to pan, scroll to zoom.',
  ...
  fr: {
    ...
    compareRaisedTitle: 'Levées déclarées',
    compareRaisedNote: 'Montants déclarés dans les mises à jour C-U (jalons) sur la période.',
    raisedTimeTitle: 'Levées déclarées cumulées dans le temps',
    raisedTimeNote: 'Cumul des montants réellement levés déclarés (mises à jour C-U) depuis le début de la collecte — historique complet, indépendant du filtre de période. Glisser pour naviguer, molette pour zoomer.',
